 ...
 * and redirects to a sanitised `next`. Any failure goes back to /join with a reason the page can
 * show; nothing here ever redirects off this origin (src/auth/next.ts).
 */
